        ...
        for(var i=0; i>=last; i++){
            ...
            for(var j=this.weekStart; j<this.days.length + this.weekStart; j++){
                ...
                if(dow == 0){
                    ...
                    if (this.url) {
                        _html +=
                          '<td class="' + cls + '" id="' + id + '" year="' + year + '" month="' + month_ + '" day="' + dow + '"><span class="weekday">' +
                            '<a href="' + this.url + '?date=' + month_ + '-' + dow + '-' + year + '">' + dow + '</a>'
                        + '</span></td>';
                    }
                    else
                    ...
                    if (this.url) {
                        _html +=
                          '<td class="' + cls + '" id="' + id + '" year="' + year + '" month="' + month_ + '" day="' + dow + '">' +
                            '<a href="' + this.url + '?date=' + month_ + '-' + dow + '-' + year + '">' + dow + '</a>'
                        + '</td>';
                    } else {
