...
public partial class BuyAdvertisments : System.Web.UI.Page
{
    #region Variables

    protected const string SubSectionName = "Куплю квартиру";

    protected const int SectionId = 3; //-- sale section
    protected const int SubSectionId = 4; //-- buy sub section

    protected AdvertismentsState AdvertismentsMode { get; set; }

    private const string ROUTE_SALE_SALE_SUBSECTION = "Route_Sale_BuySubSection";
