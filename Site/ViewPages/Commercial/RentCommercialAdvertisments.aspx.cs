...
public partial class RentCommercialAdvertisments : System.Web.UI.Page
{
    ...
    protected const string SubSectionName = "Аренда офисов";

    protected const int SectionId = 4; //-- rent_commercial section
    
    protected AdvertismentsState AdvertismentsMode { get; set; }

    private const string ROUTE_RENTCOMMERCIAL_SECTION = "Route_RentCommercialSection";
