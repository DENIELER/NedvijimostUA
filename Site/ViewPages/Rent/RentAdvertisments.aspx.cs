...
public partial class RentAdvertisments : System.Web.UI.Page
{
    ...
    protected const string SubSectionName = "Сдам квартиру";

    protected const int SectionId = 1; //-- rent section
    protected const int SubSectionId = 1; //-- rent sub section

    protected AdvertismentsState AdvertismentsMode { get; set; }

    private const string ROUTE_RENT_RENT_SUBSECTION = "Route_Rent_RentSubSection";
    ...
    private void CapturePageRequestParameters()
    {
        ...
        switch (advertismentsMode)
        {
            case VKLUCHAYA_POSREDNIKOV:
                ...
                lnkWithSubpurchases.HRef = Page.GetRouteUrl(ROUTE_RENT_RENT_SUBSECTION, new System.Web.Routing.RouteValueDictionary()
                {
